...
enum DB_PARSE_ERROR {
	...
	ERR_EXPECTED_ARRAY,
	ERR_EXPECTED_OBJECT,
	ERR_STRING_OPERATOR_BAD,
	ERR_OBJECT_OPERATOR_BAD,
	ERR_UNMATCHED_TYPES,
...
string error_message(DB_PARSE_ERROR err) {
	...
	case ERR_EXPECTED_STRING:              return "ERR_EXPECTED_STRING";
	case ERR_EXPECTED_ARRAY:               return "ERR_EXPECTED_ARRAY";
	case ERR_EXPECTED_OBJECT:              return "ERR_EXPECTED_OBJECT";
	case ERR_STRING_OPERATOR_BAD:          return "ERR_STRING_OPERATOR_BAD";
	case ERR_OBJECT_OPERATOR_BAD:          return "ERR_OBJECT_OPERATOR_BAD";
	case ERR_UNMATCHED_TYPES:              return "ERR_UNMATCHED_TYPES";
	case ERR_UNDEFINED_VARIABLE:           return "ERR_UNDEFINED_VARIABLE";
	case ERR_UNEXPECTED_TYPE:              return "ERR_UNEXPECTED_TYPE";
	case ERR_UNDEFINED_TYPE:               return "ERR_UNDEFINED_TYPE";
	case ERR_UNDEFINED_PROPERTY:           return "ERR_UNDEFINED_PROPERTY";
	...
	case ERR_ARGUMENT_TYPE_MISMATCH:       return "ERR_ARGUMENT_TYPE_MISMATCH";
	case ERR_ARGUMENT_INDEX_MISSING:       return "ERR_ARGUMENT_INDEX_MISSING";
	case ERR_CALL_FUNCTION_GLOBAL:         return "ERR_CALL_FUNCTION_GLOBAL";
	// commands
